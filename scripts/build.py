...
def layout(title: str, body_class: str, current_path: str, content: str, description: str | None = None) -> str:
  ...
  "image": "{image_url}",
  "sameAs": [
    "https://www.instagram.com/maxartevisual/",
    "https://www.youtube.com/watch?v=Z5c3R_87zzY",
...
def render_project_card(project: dict, heading_level: int, current_path: str) -> str:
    ...
    if project.get("image"):
        ...
        img_html = f'<a href="{page_url(current_path, f"/es/proyectos/{project['slug']}/")}" class="project-card__image" aria-hidden="true" tabindex="-1"><img src="{asset_url(current_path, project["image"])}" alt="" loading="lazy"></a>'
